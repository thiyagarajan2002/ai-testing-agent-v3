...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        OllamaClient llm = new OllamaClient(System.getenv().getOrDefault("OLLAMA_URL", "http://localhost:11434"), System.getenv().getOrDefault("OLLAMA_MODEL", "llama3.2"));
                ...
                try {
                    ...
                    if (!result.passed()) {
                        try {
                            ...
                            System.err.println("AI failure analysis unavailable: " + analysisError.getMessage());
                        }
                    }
