...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("=== AI Testing Agent v3.8.0 ==="); System.out.println("Commands: plan <file> [--env <name>] | suite <file> [--env <name>] | interactive | exit"); interactive(mapper,runner,reports);
    }
