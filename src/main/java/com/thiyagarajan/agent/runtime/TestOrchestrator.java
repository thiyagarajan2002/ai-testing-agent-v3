...
public final class TestOrchestrator implements AutoCloseable {
    ...
    public ExecutionResult executePlan(String file) throws Exception {
        ...
        try {
            ...
            throw new AgentExecutionException(AgentExecutionException.Category.PLAN_VALIDATION, "Invalid test plan JSON: " + path, e);
        }
    ...
    public TestPlan plan(String requirement) throws Exception {
        return runner.plan(requirement);
    }
    ...
    public void writeReport(ExecutionResult result) throws Exception {
        reports.writeAll(result);
    }
